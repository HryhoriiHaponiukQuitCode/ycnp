...
const tableColumns = {
  ...
  org_members: ["created_at","id","organization_id","role","updated_at","user_id"],
  fiscal_years: ["created_at","end_date","id","is_current","label","organization_id","start_date"],
  solicitors: ["created_at","email","id","is_active","name","notes","organization_id","phone","updated_at","user_id"],
  solicitor_fiscal_years: ["created_at","fiscal_year_id","id","letter_signature","letter_signature_title","solicitor_id","title"],
  ...
  donor_solicitor_assignments: ["created_at","donor_id","fiscal_year_id","id","is_primary","solicitor_id"],
