  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-stone-100 px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSignup} className="bg-white rounded-xl shadow-sm border border-stone-200 p-8 space-y-5">
          <h2 className="text-xl font-semibold text-center text-stone-900">Sign Up</h2>
          ...
          <p className="text-center text-sm text-stone-600">
            ...
            <Link href="/login" className="text-orange-600 hover:text-orange-700 font-medium font-semibold">
              Sign In
            </Link>
          </p>
        </form>
